namespace PluralsightDownloader
{
    ...
    {
        const string YoutubeDl = "youtube-dl.exe";
            ...
            await Task.Run(() =>
            {
                if (!File.Exists(YoutubeDl))
                {
                    ...
                    using (var client = new WebClient())
                    {
                        ...
                        client.DownloadFile(Properties.Settings.Default.YoutubeDlUri, YoutubeDl);
                    }
                }
                else
                {
                    ...
                    var psi = new ProcessStartInfo(YoutubeDl, arguments);
